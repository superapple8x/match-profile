...
const ResultsSummary = ({ totalMatches, averageMatchPercentage, highestMatch }) => {
  return (
    // Container for the summary section - Light: indigo-100 tint
    <div className="mb-6 p-5 bg-indigo-100/60 dark:bg-gray-700/60 backdrop-blur-md border border-gray-200/80 dark:border-gray-600/50 rounded-xl shadow-lg transition-all duration-300 ease-in-out"> {/* Matched parent/sibling styles */}
